    ...
    <footer className='p-2 pl-8 pr-8 lg:p-6 lg:pl-20 lg:pr-20'>
      ...
      <div className='hidden lg:flex justify-between'>
        ...
        <div className="flex icon-container2">
          ...
          <a href="https://www.linkedin.com/in/mat%C3%ADas-montone-904532280/" target="_blank" rel="noopener noreferrer" className="mr-4 text-4xl"><FaLinkedin /></a>
      ...
      <div className='flex lg:hidden flex-col items-center'>
        ...
        <div className="flex icon-container2">
          ...
          <a href="https://www.linkedin.com/in/mat%C3%ADas-montone-904532280/" target="_blank" rel="noopener noreferrer" className="mr-2 text-3xl"><FaLinkedin /></a>
